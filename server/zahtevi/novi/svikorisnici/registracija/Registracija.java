package srb.akikrasic.zahtevi.novi.svikorisnici.registracija;
...
public class Registracija {
    ...
    private String url="https://localhost:4200/potvrdaRegistracije/";
   ...
   /*
    ...
    public boolean sigurnosnaProvera(String imeNaziv,String email, String sifra,String adresa, String mesto,String tel1, String tel2,String tel3){
        ...
        if(emailPattern.matcher(email).matches()){
            if(!nepotvrdjeniKorisniciRepozitorijum.daLiJeEmailSlobodanUObeTabele(email))return false;
    ...
    public RezultatRegistracije registrujteKorisnika(@RequestBody LinkedHashMap<String, Object> parametri){
       ...
       // System.out.println(imeNaziv+" "+ email+" "+ sifra+" "+ adresa+" "+ mesto+" "+ tel1+" "+ tel2+" "+tel3);
        ...
        if(sigurnosnaProvera(imeNaziv, email, sifra, adresa, mesto, tel1, tel2, tel3)){
            ...
            nepotvrdjeniKorisniciRepozitorijum.snimiteNovogNepotvrdjenogKorisnika(imeNaziv,email, hesiranaSifra, adresa, mesto, tel1, tel2, tel3, token);
    ...
    private RezultatRegistracije vratiteRezultat(boolean rezultatRegistracije){
        RezultatRegistracije rr = new RezultatRegistracije();
        rr.setRegistracija(rezultatRegistracije);
        return rr;
    }
